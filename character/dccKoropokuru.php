...
<html>
<head>
<title>DCC Eastern Adventures Koropokuru Character Generator </title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Dungeon Crawl Classics Koropokuru Character Generator..">
	...
	<link rel="stylesheet" type="text/css" href="css/koropokuru.css">
...
<!-- JQuery -->
  ...
  <script>
       ...
       let imgData = "images/koropokuru.png";
